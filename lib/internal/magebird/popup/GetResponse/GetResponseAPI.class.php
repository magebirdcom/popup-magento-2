...
{	
  ...
  public function addCampaignPredefine($campaign,$name,$value){
		$request  = $this->prepRequest('add_campaign_predefine', array('campaign'=>$campaign,'name' => $name,'content'=>$value));
		$response = $this->execute($request);
		return $response;  
  }

  public function getCampaignPredefines($campaign){
		$request  = $this->prepRequest('get_campaign_predefines', array('campaign'=>$campaign));
		$response = $this->execute($request);
		return $response;  
  }
